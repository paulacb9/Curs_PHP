...
INSERT INTO vendedores VALUES(NULL, 1, 1, 'Fran', 'Martinez', 'Ayudante en tienda', CURDATE(), 32000, 2);
...
INSERT INTO vendedores VALUES(NULL, 3, NULL, 'Vitoria', 'Lopez', 'Mecanico jefe', CURDATE(), 50000, 2);
INSERT INTO vendedores VALUES(NULL, 4, NULL, 'Luzia', 'Lopez', 'Vendedor de recambios', CURDATE(), 13000, 8);
INSERT INTO vendedores VALUES(NULL, 5, NULL, 'Antonio', 'Lopez', 'Vendendor experto', CURDATE(), 60000, 2);
INSERT INTO vendedores VALUES(NULL, 6, NULL, 'Joana', 'Lopez', 'Ejecutivo de cuentas', CURDATE(), 80000, 1);
INSERT INTO vendedores VALUES(NULL, 6, 8, 'Luis', 'Lopez', 'Ayudante en tienda', CURDATE(), 10000, 10);

# CLIENTES #
INSERT INTO clientes VALUES(NULL, 1, 'Consturcciones Diaz Inc', 'Alcobendas', 24000, CURDATE());
...
# consultas #
select nombre, cantidad, modelo FROM clientes, encargos, coches 
    WHERE encargos.cliente_id = clientes.id 
        AND encargos.coche_id = coches.id AND coches.id=3;